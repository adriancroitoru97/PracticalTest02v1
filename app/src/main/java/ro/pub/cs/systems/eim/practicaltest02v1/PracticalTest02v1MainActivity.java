...
public class PracticalTest02v1MainActivity extends AppCompatActivity {
    ...
    private final SearchButtonClickListener searchButtonClickListener = new SearchButtonClickListener();
    private class SearchButtonClickListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            String seachInput = inputEditText.getText().toString();
            if (seachInput.isEmpty()) {
            ...
            ClientThread clientThread = new ClientThread(
                    clientAddress, Integer.parseInt(clientPort), seachInput, resultTextView
            );
            clientThread.start();
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputEditText = (EditText)findViewById(R.id.input_ac);
